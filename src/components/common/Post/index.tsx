...
const Post = (props: {postData: postDataType}) => {
  const postData: postDataType = props.postData;
  return (
    <>
      <div className='post02OuterContainer'>
        <div className='post02TopContainer'>
          ...
          <div className='post02UserDetailsContainer'>
            <Link to={`/${postData.user.username}`}>{postData.user.first_name} {postData.user.last_name}</Link>
        ...
        <div className='post02BottomContainer'>
          ...
          <div className='post02CommentContainer'>
            ...
            <p>Add a comment...</p>
            <a href='' className='PrimaryLink'>Post</a>
          </div>
        </div>
      </div>
    </>
